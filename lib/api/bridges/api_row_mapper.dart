...
/// Maps SHPH API models to existing row types so UI code stays stable.
class ApiRowMapper {
  ApiRowMapper._();
  ...
  static CategoriesRow categoryToRow(ShphCategory category) => CategoriesRow({
        'id': category.id,
        'name': category.name,
  ...
  static ProfilesRow profileToRow(Map<String, dynamic> data) => ProfilesRow({
        'id': data['id']?.toString() ?? '',
