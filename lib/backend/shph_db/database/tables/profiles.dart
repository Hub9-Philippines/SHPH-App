...
class ProfilesTable extends ShphDataTable<ProfilesRow> {
  @override
...
class ProfilesRow extends ShphDataRow {
  ProfilesRow(Map<String, dynamic> data) : super(data);

  @override
  ShphDataTable get table => ProfilesTable();
  ...
  String? get faceVerificationToken =>
      getField<String>('face_verification_token');
  set faceVerificationToken(String? value) =>
      setField<String>('face_verification_token', value);

  DateTime? get lastVerificationDate =>
      getField<DateTime>('last_verification_date');
  set lastVerificationDate(DateTime? value) =>
      setField<DateTime>('last_verification_date', value);

  double? get faceVerificationScore =>
      getField<double>('face_verification_score');
  set faceVerificationScore(double? value) =>
      setField<double>('face_verification_score', value);
}
