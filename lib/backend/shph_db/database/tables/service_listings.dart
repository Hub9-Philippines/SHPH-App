...
class ServiceListingsTable extends ShphDataTable<ServiceListingsRow> {
  @override
...
class ServiceListingsRow extends ShphDataRow {
  ServiceListingsRow(Map<String, dynamic> data) : super(data);

  @override
  ShphDataTable get table => ServiceListingsTable();
