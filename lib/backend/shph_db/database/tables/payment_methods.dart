...
class PaymentMethodsTable extends ShphDataTable<PaymentMethodsRow> {
  @override
...
class PaymentMethodsRow extends ShphDataRow {
  PaymentMethodsRow(Map<String, dynamic> data) : super(data);

  @override
  ShphDataTable get table => PaymentMethodsTable();
