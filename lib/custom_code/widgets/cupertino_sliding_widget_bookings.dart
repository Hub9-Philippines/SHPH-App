...
class CupertinoSlidingWidgetBookings extends StatefulWidget {
  const CupertinoSlidingWidgetBookings({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<CupertinoSlidingWidgetBookings> createState() =>
      _CupertinoSlidingWidgetBookingsState();
}

class _CupertinoSlidingWidgetBookingsState
    extends State<CupertinoSlidingWidgetBookings> {
  ...
  @override
  void didUpdateWidget(covariant CupertinoSlidingWidgetBookings oldWidget) {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: cupertino.CupertinoSlidingSegmentedControl<int>(
        ...
        children: {
          0: _buildSegment("In Progress", 0),
          1: _buildSegment("History", 1), // Updated to match your Parent UI
        },
