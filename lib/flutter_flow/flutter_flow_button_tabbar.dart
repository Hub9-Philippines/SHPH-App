...
class _IndicatorPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_IndicatorPainter old) => _needsPaint ||
...
class _TabBarScrollController extends ScrollController {
  ...
  ScrollPosition createScrollPosition(ScrollPhysics physics,
      ScrollContext context, ScrollPosition? oldPosition) => _TabBarScrollPosition(
      physics: physics,
      context: context,
      oldPosition: oldPosition,
      tabBar: tabBar,
...
class _FlutterFlowButtonTabBarState extends State<FlutterFlowButtonTabBar>
  ...
  double _initialScrollOffset(
      double viewportWidth, double minExtent, double maxExtent) => _tabScrollOffset(_currentIndex, viewportWidth, minExtent, maxExtent);
  ...
  Widget build(BuildContext context) {
    ...
    final wrappedTabs =
        List<Widget>.generate(widget.tabs.length, (index) => _buildStyledTab(widget.tabs[index], index));
