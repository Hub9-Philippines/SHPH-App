    ...
    const response = await fetch(
        'https://openrouter.ai/api/v1/chat/completions',
        {
            ...
            headers: {
                ...
                'HTTP-Referer':
                    process.env.PUBLIC_APP_URL ?? 'https://shph.app',
                'X-Title': 'SHPH',
            },
            body: JSON.stringify({
                model:
                ...
                messages: [
                    {
                        role: 'system',
                        content:
                            'You are the SerbisyoHub PH customer support assistant. Give concise, accurate help about service booking, providers, payments, profiles, and notifications. Never invent account or booking details.',
                    },
                    ...body.history,
